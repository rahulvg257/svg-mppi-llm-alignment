...
|:-------------|-----------------:|--------------------:|--------------------:|--------------------------:|
| aisp         |         1.77341  |                   1 |           0.0718335 |                  16.6947  |
| tsallis_aisp |         1.77341  |                   1 |           0.0718335 |                  15.6106  |
| greedy       |         0.328446 |                   1 |           0.495443  |                   6.65173 |
| best_of_n    |         0.328446 |                   1 |           0.495443  |                   4.28252 |
...
- Best average-reward method on this run: `aisp`.
- AISP beat BoN under the matched sample budget.
- Tsallis-AISP beat BoN under the matched sample budget.
